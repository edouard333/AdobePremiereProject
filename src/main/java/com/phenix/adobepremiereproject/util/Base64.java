/*
 * src: https://github.com/wting/epub-tools/blob/master/epubtools/epubgen/com.adobe.dp.epub/src/com/adobe/dp/epub/util/Base64.java
 */
 ...
 *
 * <p>
 * The <em>options</em> parameter, which appears in a few places, is used to
 ...
 * using very small files (~{@code <} 40 bytes).</li> <li>v2. 2 - Added some helper
 ...
 * calls that you were making to support the new options format ({@code int}s
 * that you "OR" together).</li>
 * <li>v1.5.1 - Fixed bug when decompressing and decoding to a byte[] using
 * <em>decode( String s, boolean gzipCompressed )</em>. Added the ability to
...
public class Base64 {
     ...
     * error, the method will return {@code null}. The object is not
     ...
     * Serializes an object and returns the Base64-encoded version of that
     * serialized object. If the object cannot be serialized or there is another
     * error, the method will return {@code null}.
     * <p>
     * Valid options:
     * <pre>
     ...
     * {@code java.io.InputStream}, given in the constructor, and encode/decode
    ...
    public static class B64InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64.B64InputStream} in either ENCODE or DECODE
         * mode.
         * <p>
         * Valid options:
         * <pre>
     ...
     * {@code java.io.OutputStream}, given in the constructor, and
    ...
    public static class B64OutputStream extends java.io.FilterOutputStream {
         ...
         *
         * @param out the {@code java.io.OutputStream} to which data will be
         * written.
         * @since 1.3
         */
        ...
        /**
         * Constructs a {@link Base64.B64OutputStream} in either ENCODE or
         * DECODE mode.
         * <p>
         * Valid options:
         * <pre>
